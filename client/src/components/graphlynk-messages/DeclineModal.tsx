...
export function DeclineModal({ thread, onDecline, onClose }: DeclineModalProps) {
  const handleDecline = () => {
    onDecline();
    onClose();
  };
      ...
      <div className="w-full max-w-lg glass-card-light dark:glass-card rounded-2xl border border-gray-200 dark:border-white/10 shadow-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-white/10">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-black dark:text-white">Decline Request</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="p-4 bg-red-50 dark:bg-red-500/10 rounded-xl border border-red-200 dark:border-red-500/20">
            <p className="text-sm text-red-700 dark:text-red-400">
              Are you sure you want to decline this request? The conversation will be marked as closed.
              You can undo this action immediately after declining.
            </p>
          </div>
        </div>
